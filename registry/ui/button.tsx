 ...
 * Token      bg accent, text accent-text, radius full, height 40, padding-x 20, motion 120ms.
 ...
 *            secondary for reversible side actions, ghost for quiet ones, tint instead of secondary on an accent-tint ground.
  ...
  "inline-flex shrink-0 max-w-full items-center justify-center gap-2 rounded-full font-medium whitespace-nowrap overflow-hidden text-ellipsis transition-[background-color,color,opacity] duration-[120ms] ease-out disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      hierarchy: {
        ...
        tint: "bg-accent-tint-2 text-accent-ink hover:bg-[color-mix(in_srgb,var(--accent)_32%,var(--surface))]",
      },
      size: {
