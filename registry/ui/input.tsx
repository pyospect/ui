 ...
 * Token      bg surface, line 1px (meaningful boundary, 3:1), focus accent-ink 2px, radius sm, height 40.
  ...
  ({ className, ...props }, ref) => (
    <input
      ...
      className={cn(
        ...
        "hover:bg-surface-2 focus:bg-surface focus:outline-0 focus:shadow-[inset_0_0_0_2px_var(--accent-ink)]",
